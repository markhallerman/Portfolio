...
struct ProjectsView: View {
    ...
    var addSortOrderToolbarItem: some ToolbarContent {
...
//            SelectSomethingView() -> With this in there is a crash after deletion of the last of multiple projects - still investigating why.
        }
